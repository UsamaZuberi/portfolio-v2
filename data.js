...
export const portfolioData = {
  ...
  projects: [
    ...
    // Personal Projects List # 2
    {
      ...
      title: 'DocuSwap',
      description:
        'A high-performance, privacy-first client-side file conversion studio built for developers and public use.',
      longDescription:
        'Engineered a sophisticated client-side conversion utility that runs entirely in the browser, using Web Workers and the Canvas API to keep the UI responsive during heavy batch operations. The app handles DOCX/PPTX to PDF, PDF to PNG/JPEG (ZIP per file), and multiple data and image conversions without server round-trips, preserving user privacy and data sovereignty. PDF rendering is powered by PDF.js with bundled CMaps and standard fonts for reliable text fidelity, while the conversion pipeline remains optimized for large files and parallel batches.',
      startYear: 2026,
      endYear: 2026,
      images: ['/images/placeholder-project.svg'],
      usedSkills: [
